...
from ultralytics.nn.modules import (
    AIFI, C1, C2, C2PSA, C3, C3TR, ELAN1, OBB, PSA, SPP, SPPELAN, SPPF, A2C2f, AConv, ADown, Bottleneck, BottleneckCSP,
    C2f, C2fAttn, C2fCIB, C2fPSA, C3Ghost, C3k2, C3x, CBFuse, CBLinear, Classify, Concat, Conv, Conv2, ConvTranspose,
    Detect, DWConv, DWConvTranspose2d, Focus, GhostBottleneck, GhostConv, HGBlock, HGStem, ImagePoolingAttn,
    Index, Pose, RepC3, RepConv, RepNCSPELAN4, RepVGGDW, ResNetLayer, RTDETRDecoder, SCDown, Segment, TorchVision,
...
##############################  魔改部分引入  ##############################
from ultralytics.nn.newmodules import *
##############################  魔改部分引入  ##############################
...
##############################  魔改部分修改  ##############################
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in {
            BottleneckCSP, C1, C2, C2f, C3k2, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fPSA,
            C2fCIB, C2PSA, A2C2f,
        }:
